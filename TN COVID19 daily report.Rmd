...
The TN State DOH releases data weekly each Wed. ~4PM, so this document does not update daily. The CDC releases data each weekday on their [site](https://covid.cdc.gov/covid-data-tracker/#cases_casesper100klast7days).
...
If you *or your child* are **5** years old or older, you are eligible to get your vaccine in Nashville (for free)- Go to one of these sites to sign up:
...
*no data- County data not updated within the past 7 days*
Instead- results represent counties near peak within the past 2 weeks.
