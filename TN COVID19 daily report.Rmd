...
counties_top10_decrease <-
  ...
  pull(name)        
```
`r ifelse(length(counties_near_peak_cases_top10) == 0, "No", length(counties_near_peak_cases_top10))` counties are currently near all-time peak new case rate. 
...
*Only counties with a decline in case averages are shown (may be \<10).* Cases are currently declining in `r length(counties_top10_decrease)` counties
